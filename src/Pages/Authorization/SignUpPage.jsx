...
export default function SignUpPage() {
    return (
        <div className="w-full h-full flex justify-center px-2 py-10">
            <div className="w-full md:w-[750px] h-[450px] bg-dark-purple-100 bg-opacity-10 shadow-lg mt-10 rounded-xl flex flex-col p-4 text-white items-center justify-center gap-5">
                ...
                <div className="flex flex-col gap-4 items-center">
                    <button className="h-12 bg-dark-purple-100 bg-opacity-70 hover:bg-opacity-100 animated-100 rounded-md font-semibold w-44">
                        Create account
                    </button>
                    <Link to="/signin">
