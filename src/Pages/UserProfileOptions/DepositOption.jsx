        ...
        <div className="w-full flex flex-col text-white gap-4">
            ...
            <div className="w-full flex justify-center p-4">
                <div className="w-full max-w-[800px] flex flex-col gap-6 p-8 bg-dark-purple-300 rounded-lg">
                    ...
                    <span className="text-xl font-semibold">
                        Your deposit: <span className="p-2 bg-zinc-600 bg-opacity-40 rounded-md">{balance.userBalance}</span>
                    </span>
                    <span className="text-xl font-semibold">
                    ...
                    <button
                        ...
                        className="w-full max-w-[200px] p-4 text-xl font-semibold bg-purple-900 bg-opacity-50 rounded-md hover:bg-opacity-80 animated-100"
                    >
                        Make a deposit!
                    </button>
                </div>
