...
export default function MarketplacePage() {
    ...
    const [lotsData, setLotsData] = useState([
        { name: "Rabbit", price: 300, owner: "TorgaW", rarity: "Heroic", describtion: "Mother and Father. I am sure learning foreign languages is very important nowadays. People want to have a possibility to get a higher education abroad or even start their career there." },
        { name: "Poop Rabbit", price: 200, owner: "TorgaW", rarity: "Common", describtion: "Mother and Father" },
        { name: "Mommy Rabbit", price: 500, owner: "FarHowl", rarity: "Legendary", describtion: "Mother and Father" },
        { name: "Rabbit`s Carrot", price: 600, owner: "FarHowl", rarity: "Epic", describtion: "Mother and Father" },
        { name: "Big Black Rabbit", price: 250, owner: "Nat", rarity: "Mythical", describtion: "Mother and Father" },
        { name: "Poor Rabbit", price: 10, owner: "Kirusha", rarity: "Guarantee", describtion: "Mother and Father" },
        { name: "Ultra Rabbit", price: 900, owner: "Mom", rarity: "Rare", describtion: "Mother and Father" },
    ]);
...
function ItemTile({ price, name, rarity, owner, setData, describtion }) {
    ...
    return (
        <div
            onClick={() => {
                ...
                setData({ price, name, rarity, owner, setData, describtion });
            }}
...
function PopUpTile({ price, name, rarity, owner, describtion }) {
    return (
        <div id="popUpVision" className="flex z-10 pointer-events-none animated-100 opacity-0 w-full h-full justify-center items-center bg-black fixed top-0 bg-opacity-70">
            <div className={"relative md:w-[500px] w-[430px] md:h-[600px] h-[470px] flex flex-col gap-4 items-center bg-dark-purple-400 border-2 md:mt-0 mt-[48px] rounded-xl shadow-lg mx-6 " + rarityColor[rarity?.toLowerCase()]}>
                ...
                <div className="flex flex-col justify-center items-center h-full w-full gap-4 px-4">
                    ...
                    <div className="max-h-[100px] text-center flex justify-center items-center py-2">
                    ...
                    }} additionalStyle="w-[300px] text-white" text={"Buy for " + price + "$"} />
                </div>
                <div id="orderConfirmation" className="animated-100 absolute w-full h-full flex pointer-events-none opacity-0 justify-center items-center rounded-xl bg-opacity-80 bg-black">
                    <div className="text-white flex flex-col gap-6 justify-center items-center rounded-xl bg-dark-purple-400 w-[250px] h-[150px]">
                        ...
                        <div className="flex gap-5">
                            ...
                            }} additionalStyle="w-[70px]" text="No" />
                        </div>
                    </div>
                </div>
            </div>
